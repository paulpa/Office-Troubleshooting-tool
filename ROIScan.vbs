' Name: Robust Office Inventory Scan - Version 1.8.5
...
Sub FindV2VirtualizedProducts
    ...
    If dicVirt2Prod.Count > 0 Then
        ...
        If RegReadValue(HKLM, REG_C2RCONFIGURATION, "CDNBaseUrl", sValue, "REG_SZ") Then
            ...
            dicC2RPropV2.Add hAtS(Array("49","6E","73","74","61","6C","6C","53","6F","75","72","63","65","20","43","68","61","6E","6E","65","6C")), GetBr(sValue)
        ...
        dicC2RPropV2.Add STR_USEDUPDATELOCATION, sValue
         ...
         'UpdateVersion
        If RegReadValue (HKLM, REG_C2RCONFIGURATION, "UpdateToVersion", sValue, "REG_SZ") Then
...
'                If sValue = "" Then sValue = STR_NOTCONFIGURED
'                dicC2RPropV2.Add STR_UPDATETOVERSION, sValue
        ElseIf RegReadValue (HKLM, REG_C2RUPDATES, "UpdateToVersion", sValue, "REG_SZ") Then
                If sValue = "" Then sValue = STR_NOTCONFIGURED
                dicC2RPropV2.Add STR_UPDATETOVERSION, sValue
        Else
...
Sub FindV3VirtualizedProducts
    ...
    If dicVirt3Prod.Count > 0 Then
        ...
        If RegReadValue(HKLM, REG_C2RCONFIGURATION, "CDNBaseUrl", sValue, "REG_SZ") Then
            ...
            dicC2RPropV3.Add hAtS(Array("49","6E","73","74","61","6C","6C","53","6F","75","72","63","65","20","43","68","61","6E","6E","65","6C")), GetBr(sValue)
            'Last known InstallSource used
            If RegReadValue(HKLM, REG_C2RSCENARIO & "Install", "BaseUrl", sValue, "REG_SZ") Then
        ...
        If RegReadValue (HKLM, REG_C2RCONFIGURATION, "UpdateBranch", sValue, "REG_SZ") Then
            dicC2RPropV3.Add STR_UPDATECHANNEL, sValue
        Else
            dicC2RPropV3.Add STR_UPDATECHANNEL, STR_NOTCONFIGURED
        End If
        ...
        If RegReadValue (HKLM, REG_C2RUPDATEPOL, "updatebranch", sValue, "REG_SZ") Then
            dicC2RPropV3.Add STR_POLUPDATECHANNEL, sValue
        Else
            dicC2RPropV3.Add STR_POLUPDATECHANNEL, STR_NOTCONFIGURED
        End If
        ...
        'If NOT dicC2RPropV3.Item (STR_UPDATECHANNEL) = STR_NOTCONFIGURED Then sValue = dicC2RPropV3.Item (STR_UPDATECHANNEL)
        If NOT dicC2RPropV3.Item (STR_UPDATELOCATION) = STR_NOTCONFIGURED Then sValue = dicC2RPropV3.Item (STR_UPDATELOCATION)
        If NOT dicC2RPropV3.Item (STR_POLUPDATECHANNEL) = STR_NOTCONFIGURED Then sValue = dicC2RPropV3.Item (STR_POLUPDATECHANNEL)
...
Function GetBr(sValue)
    ...
    If InStr(sValue, sCh1) > 0 Then sBr = hAtS(Array("43","43","20","28","43","75","72","72","65","6E","74","20","43","68","61","6E","6E","65","6C","20","2D","20","4F","44","54","3A","20","43","75","72","72","65","6E","74","29"))
    If InStr(sValue, sCh2) > 0 Then sBr = hAtS(Array("46","52","43","43","20","28","46","69","72","73","74","20","52","65","6C","65","61","73","65","20","43","75","72","72","65","6E","74","20","43","68","61","6E","6E","65","6C","20","2D","20","4F","44","54","3A","20","49","6E","73","69","64","65","72","73","2C","20","46","69","72","73","74","52","65","6C","65","61","73","65","43","75","72","72","65","6E","74","29"))
    If InStr(sValue, sCh3) > 0 Then sBr = hAtS(Array("46","52","44","43","20","28","46","69","72","73","74","20","52","65","6C","65","61","73","64","20","44","65","66","65","72","72","65","64","20","43","68","61","6E","6E","65","6C","20","2D","20","4F","44","54","3A","20","56","61","6C","69","64","61","74","69","6F","6E","2C","20","46","69","72","73","74","52","65","6C","65","61","73","65","42","75","73","69","6E","65","73","73","29"))
    If InStr(sValue, sCh4) > 0 Then sBr = hAtS(Array("44","43","20","28","44","65","66","65","72","72","65","64","20","43","68","61","6E","6E","65","6C","20","2D","20","4F","44","54","3A","20","42","75","73","69","6E","65","73","73","29"))
    GetBr = sBr
End Function
...
Sub WriteXmlLog
    ...
    Dim sXmlLine, sText, sProductCode, sSPLevel, sFamily, sSeq, sItem
